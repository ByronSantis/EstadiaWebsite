...
<head>
   ...
   <title>EstadiaChile saved</title>
...
<section class="listings">
   ...
   <h1 class="heading">Publicaciones guardadas</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>Eliminar guardado</span></button>
            <?php
               }else{ 
            ?>
      ...
      <?php
               ...
               echo '<p class="empty">No hay publicaciones agregadas<a href="post_property.php" style="margin-top:1.5rem;" class="btn">Agregar publicacion</a></p>';
            }
         }
      }else{
         echo '<p class="empty">No hay publicaciones guardadas<a href="listings.php" style="margin-top:1.5rem;" class="btn">Mostrar mas</a></p>';
      }
      ?>
