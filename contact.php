...
<head>
   ...
   <title>EstadiaChile Contact Us</title>
...
<section class="contact">
   ...
   <div class="row">
      ...
      <form action="" method="post">
         ...
         <input type="number" name="number" required maxlength="10" max="9999999999" min="0" placeholder="Ingresa tu numero" class="box">
         <textarea name="message" placeholder="Escribe un mensaje" required maxlength="1000" cols="30" rows="10" class="box"></textarea>
